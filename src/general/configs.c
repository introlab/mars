    ...
    configs * configs_construct_null(void) {
        ...
        cfgs->snk_pots = (snk_pots_cfg *) NULL;
        cfgs->mod_sst = (mod_sst_cfg *) NULL;
        cfgs->msg_tracks = (msg_tracks_cfg *) NULL;
        cfgs->snk_tracks = (snk_tracks_cfg *) NULL;
    ...
    void configs_destroy(configs * cfgs) {
        ...
        if (cfgs->snk_pots != NULL) {
            snk_pots_cfg_destroy(cfgs->snk_pots);
        }
        ...
        if (cfgs->snk_tracks != NULL) {
            snk_tracks_cfg_destroy(cfgs->snk_tracks);
        }
